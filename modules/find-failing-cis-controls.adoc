...
[role="_abstract"]
Similar to the *Policy Violations* sunburst chart in the *Configuration Management* view, the CIS controls widget provides information about failing CIS controls.
...
.Procedure
. Select *CIS Docker v1.2.0* on the CIS controls widget header.
