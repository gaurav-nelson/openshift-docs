...
You can then move your mouse over a deployment in the details panel and select the *Navigate to deployment* (arrow) icon that appears on the right to view deployment details.
