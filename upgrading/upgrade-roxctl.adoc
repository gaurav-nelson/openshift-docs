...
* xref:../installing/installing-rhacs-on-red-hat-openshift.adoc#adding-an-environment-variable-to-a-deployment_install-central-config-options-ocp[Injecting an environment variable into the Central deployment]
