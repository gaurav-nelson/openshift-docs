...
[role="_abstract"]
If you are using https://www.splunk.com/[Splunk], you can forward alerts from {product-title} to Splunk and view vulnerability and compliance related data from within Splunk.
...
. Use the token value to setup notifications in {product-title}.
