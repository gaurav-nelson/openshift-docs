...
. On the *Secrets Most Used Across Deployments* widget, move your mouse over the sunburst chart to view details about policy violations.
. Select *_n_ rated as high* (where _n_ is a number) to view detailed information about high-priority policy violations.
The *Policies* view displays a list of policy violations filtered based on the selected category.
