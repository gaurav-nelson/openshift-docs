...
You can move your mouse over these items to view more details.
...
By default, the external connections point to a common *External Entities* box, and different CIDR (Classless Inter-Domain Routing) addresses blocks in the *Network Graph* view.
